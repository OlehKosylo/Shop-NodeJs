module.exports.idModelSchema = require('./goods/idModelSchema');
module.exports.idOrderSchema = require('./invoices/idOrder.validator');
module.exports.invoiceValidorSchema = require('./invoices/invoice.validator');
module.exports.loginValidatorSchema = require('./auth/login.validator');
module.exports.notebookValidatorSchema = require('./goods/notebook.validator');
